...
const DutyLoadDashboard = dynamic(() => import('../dashboard/DutyLoadDashboard'), {
  ssr: false,
...
export default function DutyLoadPage() {
  return (
    <InvigilationGuard allowRoles={['admin']}>
      {user => (
        <InvigilationShell user={user} title="Duty Load Dashboard">
          <div className="space-y-6 p-6">
            <div>
              <h1 className="text-2xl font-bold text-slate-800">Lecturer Duty Load Dashboard</h1>
