//src/app/dashboards/bipc/attendance/page.jsx
...
export default async function AttendancePage() {
  const groupName = 'BiPC'
  const routeSegment = 'bipc'
  ...
  return (
    ...
    >
      <div className="mx-auto w-full max-w-6xl">
        ...
        {/* Existing AttendanceForm — functionality unchanged */}
        <section className="mt-2.5 overflow-hidden rounded-xl border border-slate-200/80 bg-white shadow-sm sm:mt-3">
