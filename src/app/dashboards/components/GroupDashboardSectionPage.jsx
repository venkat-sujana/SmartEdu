    ...
    if (section === 'fees') {
      return (
        <SectionCard title="Fee Dashboard" description="Group fee summary in a cleaner layout.">
          <div className="mb-6 flex flex-col gap-3 rounded-2xl border border-slate-200 bg-slate-50 p-4">
      ...
      <div className="mx-auto max-w-7xl space-y-6">
        ...
        >
          <div>
            ...
            <h1 className="mt-2 text-2xl font-black text-slate-900">{groupName} {section}</h1>
