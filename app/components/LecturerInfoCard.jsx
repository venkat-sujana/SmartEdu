...
export default function LecturerInfoCard({ user }) {
  return (
    <div className="mx-auto mt-24 mb-6 flex max-w-3xl items-center gap-5 rounded-3xl border border-blue-200 bg-gradient-to-r from-blue-50 via-sky-50 to-blue-100 p-5 shadow-lg">
      {/* Avatar / Icon circle */}
      <div className="flex h-20 w-20 items-center justify-center rounded-2xl bg-gradient-to-br from-blue-500 to-indigo-600 shadow-md">
      ...
      <div className="flex-1 space-y-2">
        ...
        <p className="flex items-center gap-2 text-sm font-medium text-blue-800 break-words">
          <span className="inline-flex h-7 w-7 items-center justify-center rounded-full bg-blue-100 text-blue-700">
        ...
        <p className="flex items-center gap-2 text-sm text-slate-800 break-words">
