...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-black flex flex-col items-center justify-start bg-gray-200 bg-[url('/images/bg-5.jpg')] bg-cover bg-center">
      <div className="bg-white p-5 rounded-xl shadow-lg flex flex-col items-center gap-4 mt-6">
        <h1 className="text-xl font-bold mb-1">🔑 Admin Dashboard</h1>
        <button
          onClick={gotoLecturer}
          className="w-52 bg-blue-600 text-white text-lg py-1 rounded font-semibold transition hover:bg-blue-700 mb-2 cursor-pointer"
        >
          Lecturer Login
        </button>
        <button
