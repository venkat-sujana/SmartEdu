      ...
      <div className="mx-auto max-w-7xl">
        <div>
          ...
          <Link href="/attendance-records/attendance-calendar">
            <button className="w-full sm:w-auto mb-4  cursor-pointer rounded-full bg-gradient-to-r from-blue-500 to-cyan-400 px-6 py-2 font-bold text-white shadow transition hover:scale-105">
              Calendar-View
            </button>
          </Link>
